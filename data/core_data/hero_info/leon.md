...
While bearing the debuff, targets will receive stacks every time they're hit by Leon in fights (one stack), on the field (one stack), with Eternal Brand's attack itself (three stacks), or with Terrifying Swing (five stacks per hit). Stacks do nothing in themselves, but represent a threshold - if Leon damages the target while they're below this threshold (not the attack which drops them below), he will instantly kill them and earn 20/35 bonus gold for each stack, then if he's in a fight he gets another attack for free. The stacks are then removed (or halved, if killed using Nightmare Slayer). Incidentally, these stacks clearly aren't stacks of Eternal Brand since the debuff still exists at zero stacks, implying the existence of a third effect - the debuff - also called Eternal Brand. What great design.

Eternal Brand (the card) is generated once at the start of the game, then once again each time an item is equipped by Leon. This leaves you in a slightly awkward position - the whole reason you take Leon is to focus a key target or two, but sooner or later you'll have generated four of these things. You get to choose between risking Leon hitting an irrelevant target or having entirely unplayable cards cluttering your deck, neither of which feels good.

Furthermore, outside of his debuff stacks Leon is just a vanilla bruiser - he has no added damage, nor all that much AP from stat growth. He'll kill a squishy eventually, but it won't be quick. If you actually want to kill a priority target before it can do whatever it is that's making you prioritise them, you'll need to draft some AoE or another targeted effect to expedite the process.

Despite this issue Leon is a strong, if niche, pick in the jungle. He may not kill his targets quickly, but he will kill them sooner or later, and that can matter a lot. Throw in a Felicity, Lubos, Xiangxi Ke etc. and that target won't be a problem for long.

Leon in top lane, on the other hand, is weird. You're forced to Brand your lane opponent for half your kit to function - but, it being top lane, that's probably a tank. Do you want your top laner to accomplish nothing in lane, or do you want him to focus something he might actually kill? Rough choice. Unless it's Frank.
