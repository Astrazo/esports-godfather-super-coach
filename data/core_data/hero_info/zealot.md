# Hero Summary
Very potent triple hero, very high cap but vulnerable to being nuked.
...
### Removed
- Zealot and his clones always share health.

### Changed
- Effect of levels and gold on Zealot's maximum health reduced from 75% to 15%.

### Variant Description
On paper something of a mixed bag; the reduction in health makes Zealot more likely to die to any kind of sizeable hit, but on the other hand, he won't die if his clones do (and they'll keep fighting if he goes down). In practice this really doesn't do much at all because if you're drafting Zealot it's because you're planning to 'roid him up with Beverly/Dylan/etc anyway, so you won't really notice anything at all besides a bit more staying power in long fights. The main downside is that this weakens Zealot's snowball potential, particularly in versions with high gold income or low equipment cost - once you've got your equipments, kill gold does much less for him. Does at least make him more reliable since if one falls over the others stay standing for a while.

# Item Build
Special case. Again, Zealot wants raw stats that work before the fight starts. If an item gives them, great, he gets three items for the price of one. If not, he's paying for item passives that he doesn't use as well as others thanks to his weakened gold scaling. A short, non-exhaustive list of solid Zealot items:

Cheap but surprisingly effective items: Dirty Little Pistol, Little Lightning, Farming Bell

Stat sticks: Inherent Shield (terrible item generally, but better than most for him), Link Line (Presence counteracted by the clones each counting separately for armour gain), Double-Layered Armour (Cheap and always active on clones), Glorious shield (ONLY while Variant is active because the clones will keep the Presence and soak hits for the original when he falls low), Giant Warhammer (buff your buffs), Fearless Headband, Big Guy Vest (third item only), Hundred ATK Sword (if you want to pay 1000 gold more for a Dirty Little Pistol)

Only good if combined: Gravity Converter & Limitless Chip (the crit isn't shared, but the stats are great and he should have a lot of health from buffs)

# Funnelling
Yes. Tutoring his cards is fine since they're generally good. Buffs are important - don't play Zealot unless you're drafting a support to bolster his statline.
