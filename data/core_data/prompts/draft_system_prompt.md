...
When you receive the scored hero candidates, choose exactly one supplied hero and position pair. Treat scores and graph reasons as authoritative facts, but use your hero-information tools to decide whether qualitative details justify selecting a lower-scored candidate.
