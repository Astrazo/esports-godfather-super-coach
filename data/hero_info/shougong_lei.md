# Hero Summary
Mediocre ADC with a damage-increasing debuff and absurdly expensive cards.

# Hero Analysis
## Hero Description
Shougong Lei finds himself in the unfortunate position of a rather schizophrenic role designation. The entire hero design revolves around the Fragile debuff, which causes the recipient to take 15/20% increased damage until the end of the next fight; while this is a pretty decent debuff in and of itself, the one role you don't really want to be applying it is the ADC. The ADC's role is to hit things very, very hard - hard enough, in fact, that the Fragile debuff should be rather redundant.
...
As an aside - note that Shougong Lei uses Mage itemisation due to being magical. Not being able to stack crit like most ADCs can really underlines the fact that the debuff is the only reason he exists. It also means his potential damage ceiling is much lower than most bot laners.
...
# Item Build
Mage. You're missing out on a bot lane ADC to bring this guy, so you'd better make sure he's packing the damage numbers to make up for that.

# Funnelling
Tutoring, no - his cards are just too expensive. He's also not a good stat dump since he has an ADC's stat growth so he's not even getting the bonus health to offset the loss of ADC itemisation.
