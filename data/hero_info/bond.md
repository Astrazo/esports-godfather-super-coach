# Hero Summary
Generic ADC with initiation options and good damage output.

# Hero Analysis
## Hero Description
Bond is an entirely generic ADC with only one real distinguishing feature - his attacks deal more damage the lower health his target is. For each 1% health the target is missing, Bond deals 1% more damage; while fairly unimaginitive, this does lead to Bond dealing quite surprisingly high damage in fights.

This bonus damage from missing health makes Bond particularly good at skirmishing, as it makes it far more likely that small, short fights will end in kills; as a result, Bond can perform well in the jungle (having decent cards for finding skirmishes as well as good stats for winning them). His cards are unimpressive in lane, so Jungle is generally his preferred role.
...
# Item Build
ADC. No reason to get fancy with it, he's just an ADC at the end of the day.

# Funnelling
Cards, not really. Stats, sure, Bond uses them as well as any other ADC.
