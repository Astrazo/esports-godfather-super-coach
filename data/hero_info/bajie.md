# Hero Summary
Extremely high damage crit-oriented ADC.

# Hero Analysis
## Hero Description
BaJie is one of the hardest hitting heroes in the game; only Deep Space can really contest him for dealing the most damage with a single attack. This is an effect of his passive, which gives him bonus crit chance and crit damage from the gold he generates - by the end of a game he can easily break 1k AP and 300% crit damage (with 100% crit chance, of course) to throw big chunky hits around.
...
### Card Analysis
The effect isn't bad, but the cost is absurd for what it does - 4 SP for what amounts to a single attack is outrageously expensive. Even if you get the crit on a hero you're unlikely to kill them since BaJie lacks any other poke tools (and you're spending half your SP on this card), and the tower damage is of limited use with no other push tools. Avoid this card until ultra-late when you can use it to get kills on any target that drops moderately low (and even then look for better uses for the SP first).

# Item Build
Crit. Lots of crit.[makeagif.com] BaJie sits with Lan in the exclusive 'we don't care if we go over 100% crit' club, since he gains crit damage from his crit chance exceeding 100%. If you're the nervous type you can throw him a GA effect as third item.

# Funnelling
Tutoring effects can work to find Cache and get it stacked early - it's not worth consistently tutoring unless you have no better options, but grabbing it once or twice early can get you to that 400 gold mark to maximise the free crit. Not worth throwing him stats though - he's going to be very squishy with or without them, and he really shouldn't need any more damage than he has.
