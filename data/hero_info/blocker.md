...
## Card 2
### Description
The SP cost of the next card played belonging to Blocker's partner is reduced by 2.
...
# Item Build
Pure Tank. Unlike most supports, Blocker both has tank base stats and also gives some shielding to its support when it takes a hit; you're incentivised to pick up whatever Presence you can to keep the attacks aimed at it, plus armour to keep it upright. Aim for the cheaper tank items though, don't go trying to first-item a "Mockery" Textbook.

# Funnelling
Funneller, not funnellee. Which is a word now, I just decided.
