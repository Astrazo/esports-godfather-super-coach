# Hero Summary
Unimpressive assassin who can focus low health targets. Sometimes.

# Hero Analysis
## Hero Description
Xiangxi Ke is a pirate ninja assassin girl cosplaying as a pirate-ninja-assassin whose playstyle is defined by her The Reaper buff. So long as she has at least one stack of this buff, her attacks in fights automatically target the lowest health enemy, expending a stack in the process. She acquires stacks by discarding her Old Time card, of which there are two in her deck (with masteries).
...
The overall result is that Xiangxi Ke simply isn't good enough to be worth drafting unless you have a very specific reason to do so. She performs her role, but not particularly effectively, nor are her cards particularly noteworthy. Look elsewhere unless you absolutely need a consistent backline targeter in your lineup. Has some small synergy with Leon thanks to his ability to force-target backliines, which can help get Xiangxi Ke to hit the things you actually want her to target instead of spending the first three rounds beating down a random support.
...
# Item Build
Assassin. She's there to stab low health targets, and she only has a limited number of stacks to do it. Make them count.

# Funnelling
Pretty good, actually, on both counts. Tutoring her cards lets you pull Old Time and throw it away repeatedly, more AP lets her cut down her target, and more health gives you the optimistic hope of her surviving more than one hit from an ADC.
