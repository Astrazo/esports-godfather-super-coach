...
Incidentally, while Hass will target whoever has buffs, the same doesn't apply to shields unless they're the result of a card. That means Traveler's Blessing will result in targeting and stealing, but something like a Blocker shield or Runic Ward will come down to whether he decides to smack them (once all the buffs are gone).
